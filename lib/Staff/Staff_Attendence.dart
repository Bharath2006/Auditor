...
class _AttendanceScreenState extends State<AttendanceScreen> {
  ...
  String _formatWorkDuration(TimeOfDay start, TimeOfDay end) {
    final startDt = DateTime(2023, 1, 1, start.hour, start.minute);
    final endDt = DateTime(2023, 1, 1, end.hour, end.minute);
  ...
  Future<void> _showDayDetails(DateTime date) async {
    ...
    final attendanceRecords = _attendanceEvents[dateKey] ?? [];
